...
```
Linux: python3 whatsappbeacon.py --username "username_to_track" --language "language_code"
```
```
On windows: python whatsappbeacon.py --username "username_to_track" --language "language_code"
```
